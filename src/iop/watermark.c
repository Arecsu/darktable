...
void gui_init(dt_iop_module_t *self)
{
  ...
  // GTK4: FontButton > Button > Box > Label
  GtkWidget *child =
    gtk_widget_get_first_child(gtk_widget_get_first_child(gtk_widget_get_first_child(GTK_WIDGET(g->fontsel))));
#else
  GtkWidget *child =
    dt_gui_container_first_child(gtk_bin_get_child(GTK_BIN(g->fontsel)));
#endif
